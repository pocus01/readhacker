...
model_id = st.radio("GPT-3.5 is faster at generating responses, while GPT-4 is smarter and can handle longer inputs. Exceeding the limit for length or number of requests will result in error. Select a suitable Large Language Model for your AI-powered reading:", ('gpt-3.5-turbo-16k','gpt-4'))
temperature = 0
