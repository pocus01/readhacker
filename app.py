...
input_text = st.text_area("I am your AI-powered reading assistant. Enter the text you want me to analyse in the box. Whether it\'s a news article, a speech, or a commentary, I\'ll do my best to assist you. My average processing time is usually below one minute.","")
conversations = []
