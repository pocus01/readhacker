...
input_text = st.text_area("I am your AI-powered reading assistant. Please input the text you would like me to analyse in the box below. Whether it\'s a news article, a speech, or a commentary, I\'ll do my best to assist you.","")
conversations = []
