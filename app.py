...
model_id = st.radio("GPT-3.5 generates faster responses and handles longer inputs. GPT-4 is smarter. Overloading inputs will cause error. Choose a suitable Large Language Model for your AI-powered reading:", ('gpt-3.5-turbo-16k','gpt-4'))
temperature = 0
