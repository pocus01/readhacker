...
model_id = st.radio("Compared to GPT-3.5, GPT-4 is smarter and can handle longer inputs, while GPT-3.5 is faster at generating responses. Exceeding the length limit will result in error. Select a Large Language Model for your AI-powered reading.", ('gpt-4','gpt-3.5-turbo'))
temperature = 0
